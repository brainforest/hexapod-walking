...
const float length_b = 78;
const float length_c = 28;
...
const float leg_move_speed = 6;
const float body_move_speed = 3;
const float stand_seat_speed = 1;
volatile int rest_counter = 0;      //+1/0.02s, for automatic rest
//functions' parameter
...
LedControl lc=LedControl(DOT8_DATA,DOT8_CLK,DOT8_CS,NBR_MTX);
